...
### NPC Behaviors
The customer NPC only has 2 behaviors, buying and selling. Buying is based off of a want [group](Assets/scripts/customerAI/customerWantsGroup.cs). Upon calling buy() the NPC iterates through the group and determines what item they want, in this simple project 
